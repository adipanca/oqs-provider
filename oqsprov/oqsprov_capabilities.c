...
static OQS_GROUP_CONSTANTS oqs_group_list[] = {
    ...
    {0xFE50, 128, TLS1_3_VERSION, 0, -1, -1, 1},
    {0xFE51, 128, TLS1_3_VERSION, 0, -1, -1, 1},
    {0xFE52, 128, TLS1_3_VERSION, 0, -1, -1, 1},
    {0xFE53, 192, TLS1_3_VERSION, 0, -1, -1, 1},
    {0xFE54, 192, TLS1_3_VERSION, 0, -1, -1, 1},
    {0xFE55, 192, TLS1_3_VERSION, 0, -1, -1, 1},
    {0xFE56, 192, TLS1_3_VERSION, 0, -1, -1, 1},
    {0xFE57, 192, TLS1_3_VERSION, 0, -1, -1, 1},
    {0xFE58, 256, TLS1_3_VERSION, 0, -1, -1, 1},
    {0xFE59, 256, TLS1_3_VERSION, 0, -1, -1, 1},
    {0xFE60, 256, TLS1_3_VERSION, 0, -1, -1, 1},
...
#ifdef OQS_ENABLE_KEM_xwing_768
    OQS_GROUP_ENTRY(xwing768, xwing768, xwing768, 29),

    OQS_GROUP_ENTRY(p384_xwing768, p384_xwing768, p384_xwing768, 30),
    OQS_GROUP_ENTRY(x448_xwing768, x448_xwing768, x448_xwing768, 31),
    OQS_GROUP_ENTRY(X25519xwing768, X25519xwing768, X25519xwing768, 32),
    OQS_GROUP_ENTRY(SecP256r1xwing768, SecP256r1xwing768, SecP256r1xwing768,
                    33),
#endif
...
int oqs_patch_codepoints() {
    ...
    if (getenv("OQS_CODEPOINT_XWING768"))
        oqs_group_list[29].group_id = atoi(getenv("OQS_CODEPOINT_XWING768"));
    if (getenv("OQS_CODEPOINT_P384_XWING768"))
        oqs_group_list[30].group_id =
            atoi(getenv("OQS_CODEPOINT_P384_XWING768"));
    if (getenv("OQS_CODEPOINT_X448_XWING768"))
        oqs_group_list[31].group_id =
            atoi(getenv("OQS_CODEPOINT_X448_XWING768"));
    if (getenv("OQS_CODEPOINT_X25519XWING768"))
        oqs_group_list[32].group_id =
            atoi(getenv("OQS_CODEPOINT_X25519XWING768"));
    if (getenv("OQS_CODEPOINT_SECP256R1XWING768"))
        oqs_group_list[33].group_id =
            atoi(getenv("OQS_CODEPOINT_SECP256R1XWING768"));
