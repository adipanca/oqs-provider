...
#define xwing768_evp_type 0
#define xwing768_input_type "xwing768"
#define xwing768_pem_type "xwing768"

#define p384_xwing768_evp_type 0
#define p384_xwing768_input_type "p384_xwing768"
#define p384_xwing768_pem_type "p384_xwing768"
#define x448_xwing768_evp_type 0
#define x448_xwing768_input_type "x448_xwing768"
#define x448_xwing768_pem_type "x448_xwing768"
#define X25519XWING768_evp_type 0
#define X25519XWING768_input_type "X25519XWING768"
#define X25519XWING768_pem_type "X25519XWING768"
#define SecP256r1XWING768_evp_type 0
#define SecP256r1XWING768_input_type "SecP256r1XWING768"
#define SecP256r1XWING768_pem_type "SecP256r1XWING768"
...
MAKE_ENCODER(, xwing512, oqsx, EncryptedPrivateKeyInfo, der);
MAKE_ENCODER(, xwing512, oqsx, EncryptedPrivateKeyInfo, pem);
MAKE_ENCODER(, xwing512, oqsx, PrivateKeyInfo, der);
MAKE_ENCODER(, xwing512, oqsx, PrivateKeyInfo, pem);
MAKE_ENCODER(, xwing512, oqsx, SubjectPublicKeyInfo, der);
MAKE_ENCODER(, xwing512, oqsx, SubjectPublicKeyInfo, pem);
MAKE_TEXT_ENCODER(, xwing512);

MAKE_ENCODER(_ecp, p256_xwing512, oqsx, EncryptedPrivateKeyInfo, der);
MAKE_ENCODER(_ecp, p256_xwing512, oqsx, EncryptedPrivateKeyInfo, pem);
MAKE_ENCODER(_ecp, p256_xwing512, oqsx, PrivateKeyInfo, der);
MAKE_ENCODER(_ecp, p256_xwing512, oqsx, PrivateKeyInfo, pem);
MAKE_ENCODER(_ecp, p256_xwing512, oqsx, SubjectPublicKeyInfo, der);
MAKE_ENCODER(_ecp, p256_xwing512, oqsx, SubjectPublicKeyInfo, pem);
MAKE_TEXT_ENCODER(_ecp, p256_xwing512);
MAKE_ENCODER(_ecx, x25519_xwing512, oqsx, EncryptedPrivateKeyInfo, der);
MAKE_ENCODER(_ecx, x25519_xwing512, oqsx, EncryptedPrivateKeyInfo, pem);
MAKE_ENCODER(_ecx, x25519_xwing512, oqsx, PrivateKeyInfo, der);
MAKE_ENCODER(_ecx, x25519_xwing512, oqsx, PrivateKeyInfo, pem);
MAKE_ENCODER(_ecx, x25519_xwing512, oqsx, SubjectPublicKeyInfo, der);
MAKE_ENCODER(_ecx, x25519_xwing512, oqsx, SubjectPublicKeyInfo, pem);
MAKE_TEXT_ENCODER(_ecx, x25519_xwing512);
MAKE_ENCODER(, xwing768, oqsx, EncryptedPrivateKeyInfo, der);
MAKE_ENCODER(, xwing768, oqsx, EncryptedPrivateKeyInfo, pem);
MAKE_ENCODER(, xwing768, oqsx, PrivateKeyInfo, der);
MAKE_ENCODER(, xwing768, oqsx, PrivateKeyInfo, pem);
MAKE_ENCODER(, xwing768, oqsx, SubjectPublicKeyInfo, der);
MAKE_ENCODER(, xwing768, oqsx, SubjectPublicKeyInfo, pem);
MAKE_TEXT_ENCODER(, xwing768);

MAKE_ENCODER(_ecp, p384_xwing768, oqsx, EncryptedPrivateKeyInfo, der);
MAKE_ENCODER(_ecp, p384_xwing768, oqsx, EncryptedPrivateKeyInfo, pem);
MAKE_ENCODER(_ecp, p384_xwing768, oqsx, PrivateKeyInfo, der);
MAKE_ENCODER(_ecp, p384_xwing768, oqsx, PrivateKeyInfo, pem);
MAKE_ENCODER(_ecp, p384_xwing768, oqsx, SubjectPublicKeyInfo, der);
MAKE_ENCODER(_ecp, p384_xwing768, oqsx, SubjectPublicKeyInfo, pem);
MAKE_TEXT_ENCODER(_ecp, p384_xwing768);
MAKE_ENCODER(_ecx, x448_xwing768, oqsx, EncryptedPrivateKeyInfo, der);
MAKE_ENCODER(_ecx, x448_xwing768, oqsx, EncryptedPrivateKeyInfo, pem);
MAKE_ENCODER(_ecx, x448_xwing768, oqsx, PrivateKeyInfo, der);
MAKE_ENCODER(_ecx, x448_xwing768, oqsx, PrivateKeyInfo, pem);
MAKE_ENCODER(_ecx, x448_xwing768, oqsx, SubjectPublicKeyInfo, der);
MAKE_ENCODER(_ecx, x448_xwing768, oqsx, SubjectPublicKeyInfo, pem);
MAKE_TEXT_ENCODER(_ecx, x448_xwing768);
MAKE_ENCODER(_ecx, X25519XWING768, oqsx, EncryptedPrivateKeyInfo, der);
MAKE_ENCODER(_ecx, X25519XWING768, oqsx, EncryptedPrivateKeyInfo, pem);
MAKE_ENCODER(_ecx, X25519XWING768, oqsx, PrivateKeyInfo, der);
MAKE_ENCODER(_ecx, X25519XWING768, oqsx, PrivateKeyInfo, pem);
MAKE_ENCODER(_ecx, X25519XWING768, oqsx, SubjectPublicKeyInfo, der);
MAKE_ENCODER(_ecx, X25519XWING768, oqsx, SubjectPublicKeyInfo, pem);
MAKE_TEXT_ENCODER(_ecx, X25519XWING768);
MAKE_ENCODER(_ecp, SecP256r1XWING768, oqsx, EncryptedPrivateKeyInfo, der);
MAKE_ENCODER(_ecp, SecP256r1XWING768, oqsx, EncryptedPrivateKeyInfo, pem);
MAKE_ENCODER(_ecp, SecP256r1XWING768, oqsx, PrivateKeyInfo, der);
MAKE_ENCODER(_ecp, SecP256r1XWING768, oqsx, PrivateKeyInfo, pem);
MAKE_ENCODER(_ecp, SecP256r1XWING768, oqsx, SubjectPublicKeyInfo, der);
MAKE_ENCODER(_ecp, SecP256r1XWING768, oqsx, SubjectPublicKeyInfo, pem);
MAKE_TEXT_ENCODER(_ecp, SecP256r1XWING768);
MAKE_ENCODER(, xwing1024, oqsx, EncryptedPrivateKeyInfo, der);
MAKE_ENCODER(, xwing1024, oqsx, EncryptedPrivateKeyInfo, pem);
MAKE_ENCODER(, xwing1024, oqsx, PrivateKeyInfo, der);
MAKE_ENCODER(, xwing1024, oqsx, PrivateKeyInfo, pem);
MAKE_ENCODER(, xwing1024, oqsx, SubjectPublicKeyInfo, der);
MAKE_ENCODER(, xwing1024, oqsx, SubjectPublicKeyInfo, pem);
MAKE_TEXT_ENCODER(, xwing1024);

MAKE_ENCODER(_ecp, p521_xwing1024, oqsx, EncryptedPrivateKeyInfo, der);
MAKE_ENCODER(_ecp, p521_xwing1024, oqsx, EncryptedPrivateKeyInfo, pem);
MAKE_ENCODER(_ecp, p521_xwing1024, oqsx, PrivateKeyInfo, der);
MAKE_ENCODER(_ecp, p521_xwing1024, oqsx, PrivateKeyInfo, pem);
MAKE_ENCODER(_ecp, p521_xwing1024, oqsx, SubjectPublicKeyInfo, der);
MAKE_ENCODER(_ecp, p521_xwing1024, oqsx, SubjectPublicKeyInfo, pem);
MAKE_TEXT_ENCODER(_ecp, p521_xwing1024);
MAKE_ENCODER(_ecp, p384_xwing1024, oqsx, EncryptedPrivateKeyInfo, der);
MAKE_ENCODER(_ecp, p384_xwing1024, oqsx, EncryptedPrivateKeyInfo, pem);
MAKE_ENCODER(_ecp, p384_xwing1024, oqsx, PrivateKeyInfo, der);
MAKE_ENCODER(_ecp, p384_xwing1024, oqsx, PrivateKeyInfo, pem);
MAKE_ENCODER(_ecp, p384_xwing1024, oqsx, SubjectPublicKeyInfo, der);
MAKE_ENCODER(_ecp, p384_xwing1024, oqsx, SubjectPublicKeyInfo, pem);
MAKE_TEXT_ENCODER(_ecp, p384_xwing1024);
